...
final class PaymentRequest
{
     ...
     * @param int         $depositFlag    Request Indicates whether the payment is to be paid automatically. Allowed
     *                                    values: 0 = no immediate payment required 1 = payment is required
     * @param string      $url            Full Merchant URL. A result will be sent to this address  request. The result
     *                                    is forwarded over customer browser
     * @param string|null $merOrderNumber Order Number. In case it is not specified, it will be used  value
     *                                    $orderNumber It will appear on the bank statement.
     */
     ...
     *
     * @param string $digest Verification signature of the string that is generated by concatenating all fields in the
     *                       order given.
     * @internal
     */
     ...
     *
     * @param $number string merchant number.
     * @internal
     */
